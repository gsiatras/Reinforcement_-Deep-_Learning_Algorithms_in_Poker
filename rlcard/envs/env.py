...
class Env(object):
    ...
    def reset(self, starter=None, agent=None, hcard=None, opcard=None, pcard1=None, pcard2=None):
        ''' Start a new game
        ...
        '''
        state, player_id = self.game.init_game(starter, agent, hcard, opcard, pcard1, pcard2)
        self.action_recorder = []
